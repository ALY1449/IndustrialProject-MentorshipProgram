...
export const registrationSlice = createSlice({
  ...
  reducers: {
    ...
    mentorProfessionalDetails: (
      state,
      action: PayloadAction<MentorProfessionalDetails>
    ) => {
      state.mentorProfessionalDetailsData.jobTitle = action.payload.jobTitle;
      state.mentorProfessionalDetailsData.organisation =
        action.payload.organisation;
      state.mentorProfessionalDetailsData.specialisation =
        action.payload.specialisation;
    },
    mentorPreferences: (state, action: PayloadAction<MentorPreferences>) => {
      ...
      state.mentorPreferences.otherSpecialisation =
        action.payload.otherSpecialisation;
    },
    skills: (state, action: PayloadAction<Skills>) => {
      state.skills.basicSkills.firstBasicSoftSkill =
        action.payload.basicSkills.firstBasicSoftSkill;
      state.skills.basicSkills.firstBasicIndustrySkill =
        action.payload.basicSkills.firstBasicIndustrySkill;
      state.skills.basicSkills.secondBasicIndustrySkill =
        action.payload.basicSkills.secondBasicIndustrySkill;
      state.skills.expertSkills.firstExpertSoftSkill =
        action.payload.expertSkills.firstExpertSoftSkill;
      state.skills.expertSkills.firstExpertIndustrySkill =
        action.payload.expertSkills.firstExpertIndustrySkill;
      state.skills.expertSkills.secondExpertIndustrySkill =
        action.payload.expertSkills.secondExpertIndustrySkill;
    },
